...
<body id="home">
 ...
 <div id="mainWrapper" style="width:70%;">
...
<center><h1><a href="<?php echo $homeurl; ?>" target="_top"><img src="./images/logo_transparentbg.png" alt="Home"></a></h1></center><br /><br />
  ...
  <div id="geoListings">
        <div class="column" style="background-color:#ffffff; padding-bottom:20px;">

              <div class="">
                <h2 style="font-size:19px; font-weight:bold; padding-left:10px;">United States</h2>
                <div class="inner">
<?php
...
$sql = "SELECT * FROM $t_countries c INNER JOIN $t_cities ct ON c.countryid = ct.countryid AND ct.enabled = '1' WHERE c.enabled = '1' GROUP BY c.countryid $sort1 LIMIT 52";
